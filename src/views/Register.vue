...
console.log("ExisteCodigo:",this.ExisteCodigo);

      if(this.ExisteCodigo == 1)  {           
      
           //Registra el nuevo usuario si la entidad esta en REPS
     /*       try { */
...
/*           } catch (error) {
        ...
        console.log("el man llego aqui",this.ExisteCodigo)
          this.EstaelCodigo = this.ExisteCodigo
      }
    },
  },
